...
if (!isset($_SESSION['id'])) {
    ...
    exit();}
include "../cnx.php";
$sql="SELECT * FROM patients where idP=$id";
$res=$cnx->query($sql);
$patient=$res->fetch();
$pwd=$patient['passwordP'];
...
<body>
  ...
  <img src="../img/<?php echo ($patient['img']); ?>" alt="Image" 
  ...
  <form action="update_pdp.php" method="post" enctype="multipart/form-data" style="display: inline-block;">
    ...
    <input type="hidden" name="id" value="<?php echo $id; ?>">
      ...
      <table>
        ...
        <tr>
          <th>Birth Date</th>
          <td><?php echo $patient['dateP'] ?></td>
        </tr>
      </table>
      <button class="btn" style="margin-top: 10px;"  onclick="window.location.href='edit_profile.php?id=<?php echo $patient['idP']; ?>'">Edit Profile</button>
    </div>
