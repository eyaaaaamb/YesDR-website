...
include "../cnx.php";
$patients = $cnx->query("SELECT idP, CONCAT(nomP, ' ', prenomP) as full_name FROM patients")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="form">
        ...
        <form action="add_appointements_action.php" method="post">
            <div class="form-group">
                ...
                <select id="patientId" name="idP" required>
                    <option value="">Select a patient</option>
                    <?php foreach ($patients as $patient): ?>
                        <option value="<?php echo ($patient['idP']); ?>">
                            <?php echo ($patient['idP']." :". $patient['full_name']) ; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
